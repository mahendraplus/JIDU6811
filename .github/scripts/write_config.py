#!/usr/bin/env python3
"""Writes OpenWrt .config for JioRouter AX6000 (JIDU6J11-6811 / JIDU6811) build matching working firmware"""
import sys
...
config = [
    ...
    # Strip kernel debug symbols & bloat to keep vmlinux <= 26.8MB
    ...
    # Build network & Wi-Fi drivers as modules (=m) matching working.itb layout
    ...
    # Wireless & network tools in initramfs (=y)
    "CONFIG_PACKAGE_iw=y",
    ...
    # Firmware and userland apps as modules (=m)
