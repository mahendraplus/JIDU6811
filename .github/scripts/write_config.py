#!/usr/bin/env python3
"""Writes minimal OpenWrt .config for JioRouter AX6000 (JIDU6J11-6811 / JIDU6811) matching working 25.6MB vmlinux footprint"""
import sys
...
config = [
    ...
    # Strip kernel debug symbols & bloat to keep vmlinux <= 25.6MB
    ...
    # Do NOT include =m packages in initramfs config to prevent packing 43 .ko files into CPIO rootfs!
    "# CONFIG_PACKAGE_ath11k-firmware-ipq9574 is not set",
